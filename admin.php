...
<html lang="en">
  ...
  <body>
      ...
      <div class="container"  style="background-color: #F9F5F6;">
        ...
        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light">
              ...
              <div class="card-img-overlay mt-5 text-center">
               <a href="daftar_menu.php" class="btn btn-primary text-light" style="background-color: #FFADAD; ">VIEW PRODUCT LIST</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              ...
              <div class="card-img-overlay mt-5 text-center">
               <a href="pesanan.php" class="btn btn-primary text-light" style="background-color: #FFADAD; ">SEE ORDER</a>
              </div>
            </div>
          </div>
        </div>
