  ...
  <div class="container">
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="edit.php" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-primary" name="tambah" style="background-color: #EF9F9F;">Edit</button>
        <button type="reset" class="btn btn-danger" name="reset" style="background-color: #F4BFBF; ">Hapus</button>
  </div>
  </div>
