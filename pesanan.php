        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="detail_pesanan.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-primary" style="background-color: #EF9F9F;">Detail</a>
             

              <a href="clear_pesanan.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-danger" style="background-color: #F4BFBF; ">Hapus Data</a>
            </td>
          </tr>
          <?php $nomor++; ?>
          <?php endforeach; ?>
