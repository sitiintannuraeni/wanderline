...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <a href="tambah_menu.php" class="btn btn-success mt-3 btn-block text-light" style="background-color: #EF9F9F;">ADD PRODUCT LIST</a>
        <div class="row">
            ...
            <div class="card brder-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label><br>
                <a href="edit_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-danger btn-sm btn-block text-light" style="background-color: #EF9F9F;">EDIT</a>

              <a href="hapus_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-danger btn-sm btn-block text-light" style="background-color: #F4BFBF; ">HAPUS</a>
              </div>
            </div>
          </div>
              <?php endforeach; ?>
